...
(function($) {
    ...
    $.fn.extend({
        ...
        spRandom: function(options) {
            ...
            //alter sprite state
               var ct = parseInt($(this).css("top").replace("px",""));
        	var cl = parseInt($(this).css("left").replace("px",""));
        	//positive means rising 
        	var dt = t-ct;
        	//positive means going left
        	var dl = l-cl;
              
              while(Math.abs(dt)<300 && Math.abs(dl)<300){
        		 var r = $._spritely.randomIntBetween;
               	  t = r(options.top, options.bottom);
                  l = r(options.left, options.right);;
                  dt = t-ct;
                  dl = l-cl;
        		}
        	...
        	//going more left or right than up and down
        	if(Math.abs(dt)<Math.abs(dl)){
               ...
               // $(this).alterState(t,l,$(this),options.top,options.left,options.right,options.bottom);
                $('#' + el_id).animate({
                    top: t + 'px',
                    left: l + 'px'
                }, options.speed)
        ...
        alterState: function(t,l,obj,tb,lb,rb,bb) {
        	var ct = parseInt($(obj).css("top").replace("px",""));
        	var cl = parseInt($(obj).css("left").replace("px",""));
        	//positive means rising 
        	var dt = t-ct;
        	//positive means going left
        	var dl = l-cl;
        	...
        	$("#info").html(" T:"+t+" L:"+l+"<br/>"+"CT:"+ct+" CL:"+cl+"<br/>"+" DT:"+dt+" DL:"+dl);
